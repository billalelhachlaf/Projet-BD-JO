...
CREATE  TABLE LOG (
                      idLog NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
                      idAuteur VARCHAR(120) NOT NULL ,
                      action VARCHAR(20) NOT NULL ,
                      dateHeureAction DATE NOT NULL,
                      ligneAvant VARCHAR(200),
                      ligneApres VARCHAR(200)
);
